[1]: https://raw.githubusercontent.com/liticer/assets/master/machinery/example_worker.png
[2]: https://raw.githubusercontent.com/liticer/assets/master/machinery/example_worker_receives_tasks.png
...
[![Travis Status for liticer/machinery](https://travis-ci.org/liticer/machinery.svg?branch=master&label=linux+build)](https://travis-ci.org/liticer/machinery)
[![godoc for liticer/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/liticer/machinery/v1)
[![codecov for liticer/machinery](https://codecov.io/gh/liticer/machinery/branch/master/graph/badge.svg)](https://codecov.io/gh/liticer/machinery)

[![Go Report Card](https://goreportcard.com/badge/github.com/liticer/machinery)](https://goreportcard.com/report/github.com/liticer/machinery)
[![GolangCI](https://golangci.com/badges/github.com/liticer/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for liticer/machinery](https://sourcegraph.com/github.com/liticer/machinery/-/badge.svg)](https://sourcegraph.com/github.com/liticer/machinery?badge)
...
```sh
go get github.com/liticer/machinery/v1
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/liticer/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/liticer/machinery/v1/log` package:
